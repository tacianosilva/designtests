...
public class DesignWizard {
	...
	/**
	 * Returns the <code>AnnotationNode</code> object associated with the annotation
	 * with the given string name.
	 * @param    annotationName   the fully qualified name of the desired annotation.
	 * @return    the <code>AnnotationNode</code> object for the annotation with the
	 *             specified name.
	...
	/**
	 * Returns a <code>java.util.Set</code> containing <code>AnnotationNode</code> objects reflecting all
	 * the annotations extracted.
